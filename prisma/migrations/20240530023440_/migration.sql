/*
  ...
  - You are about to drop the column `biograpgy` on the `users` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "users" DROP COLUMN "biograpgy",
...
CREATE TABLE "channels" (
    ...
    "name" TEXT NOT NULL,
    "tags" TEXT[],
    "thumbnail" TEXT NOT NULL DEFAULT 'https://placehold.co/600x400',
